const experience = [
  ...
  },
  {
    ...
    description: {
      en: '✯Developed and deployed 25+ software projects using Angular, C#, and MySQL, driving business growth and improving operational efficiency by 15%. \n\n✯Designed and implemented a cloud-based inventory management system on AWS, enabling real-time tracking and reporting, resulting in a 30% reduction in inventory costs and a 40% increase in order processing speed. \n\n✯Integrated 10+ 3rd-party services into existing applications, expanding system functionality and enhancing user experience, leading to a 20% increase in client satisfaction. \n\n✯Applied UX/UI principles to redesign 5+ applications, significantly enhancing client engagement by 60% and reducing user drop-off rates by 15%. \n\n✯Participated in 2+ code reviews weekly, improving the codebase and fostering a culture of continuous learning, resulting in a 50% improvement in code quality metrics. \n\n✯Engaged in 1+ technical training sessions monthly on DevOps, cloud computing, and application architecture, applying new skills to enhance team projects.',
      ta: '✯செயல்பாட்டு திறனை மேம்படுத்தும் .dat முதல் .csv மாற்றி மற்றும் NIWE டாஷ்போர்டு போன்ற பல்வேறு மென்பொருள் கருவிகளை உருவாக்கினேன்.\n\n✯ஆராய்ச்சி முடிவுகளை மேம்படுத்த முன்னேற்றமான தரவுப்பயன்பாட்டு தொழில்நுட்பங்களைப் பயன்படுத்தினேன்.\n\n✯தகுதியான, தொழில்முறை மற்றும் திறமையான தொடர்புகள் மூலம் நேர்மறை குழு இயங்கலை ஊக்குவித்தேன்.\n\n✯தகவல் பகிர்வை எளிமைப்படுத்தும் வகையில் விரிவான ஆவணங்களை பராமரித்தேன்.\n\n✯தொடர்ச்சியான கற்றல் மற்றும் தொழில்முறை திறமைகளுக்கான ஆற்றலை வெளிப்படுத்தினேன், புதிய சவால்களை சமாளிக்க தயாராக உள்ளேன்.',
    },
    tags: [
  ...
  },
  {
    ...
    description: {
      en: '✯Contributed to the development of eCommerce solutions using WordPress and Shopify, leading to a 15% increase in customer engagement in the first year. \n\n✯Developed and deployed 5 responsive web pages using HTML, CSS, and JavaScript, focusing on load time optimization, resulting in a 20% reduction in page loading speeds. \n\n✯Assisted in managing a MongoDB database of over 100,000 entries, learning best practices in database design. \n\n✯Participated in a capstone project developing a data analysis tool using Python, improving data processing times by 15%. \n\n✯Helped integrate testing with Jest, achieving 70% code coverage on key features. \n\n✯Worked in an Agile team of 6, contributing to sprint planning, resulting in a 20% improvement in project delivery efficiency over three months.',
