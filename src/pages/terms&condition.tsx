...
export default function TermsAndConditions() {
  return (
    <>
      <Head>
        <title>Terms and Conditions | RaniyDream</title>
      </Head>
      <TermsAndConditionsContainer>
        ...
        <p>Welcome to RaniyDream.engineer. By accessing or using this website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please do not use this site.</p>

        <h3>1. Acceptance of Terms</h3>
        <p>By using RaniyDream.engineer, you acknowledge that you have read, understood, and agree to these Terms and Conditions, along with the Privacy Policy.</p>
        ...
        <p>RaniyDream.engineer is based on the project <strong>Evander Inacio Portfolio</strong>, which was originally developed and publicly shared on GitHub by Evander Inacio.</p>
        ...
        <p><strong>Disclaimer:</strong> The creator of RaniyDream.engineer does not claim ownership of the original "Evander Inacio" project or its intellectual property. All rights to the original code are retained by the original creator.</p>
        ...
        <p>RaniyDream.engineer is provided "as is," without warranties of any kind.</p>
        ...
        <p><strong>RaniyDream R</strong><br />
          ...
          Website: <a href="https://RaniyDream.engineer">RaniyDream.engineer</a>
        </p>
      </TermsAndConditionsContainer>
      <ScrollTop />
      <Footer />
